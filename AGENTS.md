...
- **当前活跃任务**(从 PLAN.md 拉):MATH-014 ✅ 收尾(10/10)· MATH-003 ✅ 收尾(19/19 教学要点 100% 完成 v0.6.30)· MATH-015 [~] 接 M3 LLM,等 user 配 M3_API_KEY(配后 v0.6.22 完成)· MATH-016 [ ] 初中几何场景集 8 候选(等 MATH-015 后启动)· MATH-004/005/006/007 [ ]
