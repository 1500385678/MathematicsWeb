...
- [~] **MATH-016** · 初中几何场景集(8 场景)
  - **预计 commit 数: 4**(首批 2 + 第二批 1 + 第三批 1 + 目录/AGENTS 同步等已分别合批,每 10 分钟 1 场景)
  - 描述: 对位人教版初中数学 7-9 年级,8 个核心几何场景。沿 MATH-014 节奏分批做
  - **进度: 7/8**(v0.6.36 完成 2 个 + v0.6.37 完成 2 个 + v0.6.38 完成 2 个 + v0.6.39 完成 1 个:31 + 32 + 33 + 34 + 35 + 36 + 37)
  - 候选清单(8 场景,user 可调):
...
- **最后更新**: 2026-08-26 · v0.6.39 + MATH-018 入队
- **更新者**: math-advisor(对话驱动框架启用)
- **本轮改动**: (1) **MATH-016 第四批 1/8 完成 v0.6.39**:37_three-views-3d(3D 唯一:正交投影三视图 / 中国第一角 / 4 形状:长方 / 圆柱 / 四棱锥 / L 形组合 + 主 V / 俯 H / 左 W 三视图实时同步)· 29089 字节(2) viewer.js SCENES 数组加 1 项(36→37)(3) AGENTS §0 v0.6.38→v0.6.39 + 进度 36/36→37/37 + 教学要点 25/25→26/26 + 活跃任务 MATH-016 6/8→7/8(4) AGENTS §2 目录树加 37(5) AGENTS §6.6 决策 append v0.6.39(6) AGENTS §8 里程碑加 v0.6.39(7) README 36→37 场景 + 速览表"数学 × 初中几何"行加 1 项(8) PLAN MATH-016 进度 6/8→7/8 + 子项 37 [~] + 重复行清理(原 line 45-47 重复 36/37/38 段删除)(9) **本批加 [ ] MATH-018 天文数学场景集 10 候选**(对位天文学基础 + 宇宙学:开普勒/多普勒-红移/双星/视差/星等/轨道共振/潮汐锁定/银河系旋臂/日月食/岁差,ID 45-54,7 commit 跨 3-4 session)
