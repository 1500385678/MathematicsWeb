...
- [~] **MATH-014** · 加 10 个几何类场景(21-30)
  ...
  - 场景清单(按 ID):
    - ✅ 21_voronoi(沃罗诺伊图 / 计算几何 / 地图分区)— v0.6.22 第一批
    - ✅ 22_delaunay(德劳内三角剖分 / 计算几何 / 地形建模)— v0.6.22 第一批
    - ✅ 23_ellipse-reflection(椭圆光学反射 / 应用物理 / 天文望远镜)— v0.6.22 第一批
...
- [~] **MATH-003** · 19 个场景补 `getLesson()` 教学要点
  - **预计 commit 数: 9**(剩 9 个场景,每批 2 场景 1 commit,每批 10-20 分钟)
  ...
  - 进度(2026-08-25 v0.6.9 → v0.6.10 → v0.6.16 → v0.6.17 → v0.6.21): 10/19 — 01/03/04/06/09/11/12/14/15/18/20 已加 getLesson
  - 优先级子项(教学价值排序,✅ = 已加):
    ...
    - 剩余 9 个按教学价值排序,下一批 02_planetary-orbits + 13_riemann-sum
