...
- [~] **MATH-011** · 融合 2 个产品规划 .md 到 PLAN,做开发计划清单
  - 描述: `数学顾问开发架构与计划.md` + `项目开发计划.md` 90% 重叠(都是数学顾问产品立项,后者是前者的精简+更新版)。融合进 PLAN.md,做一份完整的"产品开发计划清单",跟 AGENTS.md 校验去重
  - 验收: (1) PLAN.md 加"## 产品开发计划"段(2) 内容去重精简 (3) AGENTS.md 不冲突不动 (4) 2 个 .md 文件保留原样(用户没让删,git 可查)
  - 创建: 2026-08-25
  - 依赖: 无
  - 发现者: 用户指令
