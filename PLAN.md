...
- **最后更新**: 2026-08-25 · v0.6.33
- **更新者**: math-advisor(对话驱动框架启用)
- **本轮改动**: (1) 加 [ ] MATH-016 初中几何场景集 8 候选 (2) AGENTS 瘦身 v0.6.31:371→201 行 + 新建 .Log/ (3) AGENTS 再瘦身 v0.6.32:201→95 行 + 场景规范搬 `.Log/` (4) **AGENTS 恢复详细目录结构 v0.6.33:95→149 行**(30 场景 + 子文件全列),**结构优先,不能压扁**
- **配套 cron**: math-advisor-daily-wake(每天 10:30)
- **配套反馈收件箱**: `D:\Mac\Mac\Mac\Consultant\.Shared\feedback_inbox.json`
- **2026-08-25 重大重构**:AGENTS.md 拆分为 3 文件体系(AGENTS 本体 + PLAN 任务 + .Log/ 能力库/项目宏观/规范),AGENTS 维持 149 行,**结构 100% 完整,其他部分紧凑**
