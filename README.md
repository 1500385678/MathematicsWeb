...
![v0.2.0](https://img.shields.io/badge/version-v0.2.0-6ee7b7)
...
| 🌀 **双摆混沌** | 数学 × 物理 |  8 条对照摆初值差 0.001 | RK4 积分 · 蝴蝶效应 · 几秒后轨迹分道扬镳 |
| ⛰️ **梯度下降** | 数学 × 机器学习 | `θ ← θ − η·∇f(θ)` | 3D 损失曲面 + 优化路径 · bowl/Rosenbrock/马鞍 |
