...
> **40 场景 · 2D + 3D 双模 · AI 教学助手 · 零构建 · 断网能跑**
...
| 数学 × 高中解析几何 | 圆锥曲线统一(r=ed/(1+e·cos θ)·e<1 椭圆/e=1 抛物/e>1 双曲) · 椭圆解析(x²/a²+y²/b²=1·r1+r2=2a·光学反射 F1↔F2) · _后续 4 场景(双曲线/抛物线/参数方程/极坐标)沿 MATH-016 节奏分批做_ _(人教版选择性必修第一册)_ |
